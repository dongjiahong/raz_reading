...
ZenRead PDF is a minimalist, local-first PDF reader with built-in history management. It processes PDFs entirely in the browser using IndexedDB and `react-pdf`.
